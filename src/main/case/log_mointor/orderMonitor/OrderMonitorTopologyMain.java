...
public class OrderMonitorTopologyMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        topologyBuilder.setSpout("kafka-spout1", new RandomSpout(), 2);
        topologyBuilder.setSpout("kafka-spout2", new RandomSpout(), 2);
        topologyBuilder.setSpout("kafka-spout3", new RandomSpout(), 2);
        topologyBuilder.setSpout("kafka-spout4", new RandomSpout(), 2);

        topologyBuilder.setBolt("paymentInfoParser-bolt", new PaymentInfoParserBolt(), 3)
        				.shuffleGrouping("kafka-spout1")
        				.shuffleGrouping("kafka-spout2");
